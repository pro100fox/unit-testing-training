...
@WebServlet("/student/deleteAll")
public class StudentDeleteAll extends HttpServlet {
	public static final Logger LOG = Logger.getLogger(StudentDeleteAll.class);
	private static final long serialVersionUID = 1L;
	private University university;
       
    public StudentDeleteAll() {
        super();
