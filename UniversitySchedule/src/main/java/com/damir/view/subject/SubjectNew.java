...
@WebServlet("/subject/new")
public class SubjectNew extends HttpServlet {
	public static final Logger LOG = Logger.getLogger(SubjectNew.class);
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			Subject persistedSubject = university.setSubject(subject);
			response.sendRedirect("edit/" + persistedSubject.getId());
