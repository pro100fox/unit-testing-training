...
@WebServlet("/subject/deleteAll")
public class SubjectDeleteAll extends HttpServlet {
	public static final Logger LOG = Logger.getLogger(SubjectDeleteAll.class);
	private static final long serialVersionUID = 1L;
	private University university;
       
    public SubjectDeleteAll() {
        super();
