...
public class ScheduleItemEdit extends HttpServlet {
	public static final Logger LOG = Logger.getLogger(ScheduleItemEdit.class);
	private static final long serialVersionUID = 1L;
	private University university;
       
    public ScheduleItemEdit() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			scheduleItem.setId(Integer.parseInt(request.getParameter("id")));
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			ScheduleItem scheduleItem = university.getSchedule(id);
